package com.restaurant.teditiansukma.adapter;
...
import com.restaurant.teditiansukma.model.RestaurantItem;
...
public class RestaurantAdapter extends RecyclerView.Adapter<RestaurantAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_restaurant, parent, false);
