...
import static com.restaurant.teditiansukma.data.Constans.REGISTER;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void initBinding(){
        ...
        username = findViewById(R.id.et_reg_input_userid);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(name.getText().toString().equals("")){
                    Toast.makeText(RegisterActivity.this, "Nama belum keisi Bos", Toast.LENGTH_SHORT).show();
                }else if(username.getText().toString().equals("")){
                    Toast.makeText(RegisterActivity.this, "Username belum keisi Bos", Toast.LENGTH_SHORT).show();
                }else if(password.getText().toString().equals("")){
                    Toast.makeText(RegisterActivity.this, "Password belum keisi Bos", Toast.LENGTH_SHORT).show();
                }else {
                    register();
                }
            }
